 ...
 */
package com.website.domain.security;

import java.util.Date;
import java.util.List;

import com.website.domain.PrimaryKey;
...
public class Menu extends PrimaryKey {
    ...
    public boolean isTopLevel() {
        return getParent() == null || Integer.valueOf(0).equals(this.parent.getId());
    }
    
    public String getState() {
    	return isTopLevel() ? "closed" : null;
    }
