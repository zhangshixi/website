...
import com.website.helper.VisitorHolder;
import com.website.loader.ConfigPropertyLoader;
import com.website.loader.SystemPropertyLoader;
...
public abstract class BaseController {
	...
	protected InvokeResult success() {
		return success(null);
	}
	protected InvokeResult success(String message) {
		return new InvokeResult(true, message);
	}
	protected InvokeResult error() {
		return error(null);
	}
	protected InvokeResult error(String message) {
	...
	public static class InvokeResult {
		...
		public InvokeResult(boolean success, String message) {
