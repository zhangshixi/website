...
<div id="addDialog" title="新增管理员" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px" closed="true" buttons="#addDialogButtons">
	<form id="addForm" method="post" action="${ctx}/admin/new">
		<div class="fitem">
			<label>名称:</label>
